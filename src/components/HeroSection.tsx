...
export function HeroSection({ animationReady = false }: HeroSectionProps) {
  return (
    <section className="relative w-full overflow-hidden">
      <h1 className="absolute top-28 left-0 right-0 z-99 text-center px-8 text-tertiary scale-125">
        <motion.div
          ...
          animate={
            animationReady
              ? { clipPath: "inset(0 0% 0 0)", opacity: 1, scale: 1.45 }
              : { clipPath: "inset(0 100% 0 0)", opacity: 0.6, scale: 1.45 }
          }
